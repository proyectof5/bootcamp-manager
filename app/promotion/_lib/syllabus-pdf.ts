// @ts-nocheck
/* eslint-disable */
// Migrado de public/js/syllabus-pdf.js (spec 0014 Fase C) — port fiel 1:1.
// initSyllabusPdf() ejecuta el cuerpo original (lo llama page.tsx en su secuencia
// de carga cliente), evitando ejecucion en SSR/export. Expone window.SyllabusPDF
// (lo consume promotion-detail.js). @ts-nocheck: cuerpo legacy verbatim (deuda: tipar).
export function initSyllabusPdf() {
/**
 * syllabus-pdf.js
