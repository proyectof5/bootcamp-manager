...
| Gantt — preservar vista y nodos abiertos al actualizar un elemento | 🟡 [gantt-preservar-estado-al-actualizar.md](gantt-preservar-estado-al-actualizar.md) | `generateGanttChart` / submit `#item-edit-form` (promotion-detail.js), `buildGanttDataset` (gantt-adapter.js) |
